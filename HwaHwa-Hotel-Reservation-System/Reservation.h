...
public:
	...
	void reversationScreen(vector <Reservation>&);
    void customerReservationScreen(vector<Reservation>&);
    void addCustomerReservation(vector<Reservation>&);
    int getReservationNights();
    int getReservationNOP();
    int getReservationMealType();
    bool getReservationCarParkRequired();
    int getReservationRoomType(int);
    string getReservationDate();
    void confirmReservation(vector <Reservation>& reservations);
