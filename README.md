...
## Overview
This sheet calculates the total price based on the selected room type, meal plan, and number of nights.
...
## Steps to Use
1. Input the number of nights, room type, and meal plan in their respective columns.
2. The formula in the `total_price` column will automatically compute the final amount.
